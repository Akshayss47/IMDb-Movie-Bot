...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/+O7WftIe2ovRlMWZl"),
                InlineKeyboardButton(" CuFilms ", url="https://t.me/+O7WftIe2ovRlMWZl")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/Ak_Botx'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/Ak_Botx')
            ],
            [
                InlineKeyboardButton('🎬 CuFilms 🎬', url=f'https://t.me/+O7WftIe2ovRlMWZl')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/Ak_Botx'),
            InlineKeyboardButton(' CuFilms ⭕️', url='https://t.me/+O7WftIe2ovRlMWZl')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/Ak_Botx'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/Ak_Botx")
    ])
